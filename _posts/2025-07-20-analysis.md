...
tags:
  ...
  - 'AI종목분석/예측'
  - '국내급등종목 분석'
last_modified_at: '2025-07-20T05:35:57+09:00'
title: '[2025-08-13] - Post'
layout: 'post'
lang: 'ko'
permalink: '/posts/2025-07-20-analysis/'
alt_en: '/en/posts/2025-07-20-analysis/'
---
...
<p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 210,500.00</p>
...
<p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 72.82</p>
...
<p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 18.01</p>
...
<div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
<h3 style="color:#111;margin:0 0 0.5em;">Healthpeak Properties, Inc. <span style='font-size:0.9em;color:#666;'>(DOC)</span></h3>
<p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 18.32</p>
...
<p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 2.26</p>
<p style="color:#28a745;margin:0.3em 0;"><strong>📈 변동률:</strong> +5.12%</p>
...
<p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 69.85</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 현대차 (005380)</h3>
  <p><strong>현재가:</strong> 210500.00 | <strong>변동률:</strong> 0.24% | <strong>거래량 비율:</strong> 0.41배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 Block, Inc. (XYZ)</h3>
  <p><strong>현재가:</strong> 72.82 | <strong>변동률:</strong> 2.95% | <strong>거래량 비율:</strong> 1.27배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  ...
  <p><strong>현재가:</strong> 18.01 | <strong>변동률:</strong> 1.64% | <strong>거래량 비율:</strong> 1.29배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 Healthpeak Properties, Inc. (DOC)</h3>
  <p><strong>현재가:</strong> 18.32 | <strong>변동률:</strong> -0.22% | <strong>거래량 비율:</strong> 0.86배</p>
  <p><strong>설명:</strong><br>Physicians Realty Trust is a self-managed healthcare real estate company organized to acquire, selectively develop, own and manage healthcare properties that are rented to physicians, hospitals and healthcare delivery systems.
→ **Source**: Alpha Vantage
→ 🇰🇷 **한국어 번역**: Physicians Realty Trust는 의사, 병원 및 의료 전달 시스템에 임대되는 의료 부동산을 인수, 선별적으로 개발, 소유 및 관리하기 위해 조직된 자체 관리형 의료 부동산 회사입니다.</p>
  <img src="/assets/chartimg/DOC_expert_chart.png" style="width:100%;max-width:600px;height:auto;border-radius:4px;margin-top:10px;" />

<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 Veritone, Inc. (VERI)</h3>
  <p><strong>현재가:</strong> 2.26 | <strong>변동률:</strong> 5.12% | <strong>거래량 비율:</strong> 4.57배</p>
  <p><strong>설명:</strong><br>Veritone, Inc. provides artificial intelligence (AI) computing solutions in the United States and the United Kingdom. The company is headquartered in Denver, Colorado.
→ **Source**: Alpha Vantage
→ 🇰🇷 **한국어 번역**: Veritone, Inc. 는 미국과 영국에서 인공 지능 (AI) 컴퓨팅 솔루션을 제공합니다. 이 회사는 콜로라도주 덴버에 본사를 두고 있습니다.</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  ...
  <p><strong>현재가:</strong> 69.85 | <strong>변동률:</strong> -1.05% | <strong>거래량 비율:</strong> 0.96배</p>
...
→ **Source**: Alpha Vantage
→ 🇰🇷 **한국어 번역**: 코카콜라 컴퍼니 (Coca-Cola Company) 는 델라웨어의 일반 회사법에 따라 설립된 미국 다국적 음료 회사이며 조지아주 애틀랜타에 본사를 두고 있습니다. 코카콜라 회사는 무알코올 음료 농축액과 시럽의 제조, 소매 및 마케팅에 관심을 가지고 있습니다.</p>
  <img src="/assets/chartimg/KO_expert_chart.png" style="width:100%;max-width:600px;height:auto;border-radius:4px;margin-top:10px;" />
...
<div style='border:1px solid #444;padding:16px;border-radius:10px;margin-bottom:24px;color:#eee;font-family:sans-serif;'><h2 style='font-size:1.2rem;margin-bottom:12px;'>🔹 포스코퓨처엠 (003670)</h2><div style='border:1px solid #555;padding:12px;border-radius:8px;margin-bottom:12px;'><h3 style='margin-bottom:8px;color:#fff;'>⏱️ 1D 분석</h3><p><strong>💰 현재가:</strong> $156,900.00</p><p><strong>📊 거래량:</strong> 4,255,832</p><p><strong>📈 RSI:</strong> 73.5</p><p><strong>📉 MACD:</strong> 5391.08</p><p><strong>📌 예측:</strong></p><ul><li style='color:#4dabf7;font-weight:600;'>3 기간 → <strong>Hold</strong> (신뢰도 53.51%)</li><li style='color:#4dabf7;font-weight:600;'>5 기간 → <strong>Hold</strong> (신뢰도 52.57%)</li><li style='color:#4dabf7;font-weight:600;'>10 기간 → <strong>Hold</strong> (신뢰도 53.88%)</li></ul></div><div style='border:1px solid #555;padding:12px;border-radius:8px;margin-bottom:12px;'><h3 style='margin-bottom:8px;color:#fff;'>⏱️ 1WK 분석</h3><p><strong>💰 현재가:</strong> $156,900.00</p><p><strong>📊 거래량:</strong> 5,189,314</p><p><strong>📈 RSI:</strong> 64.63</p><p><strong>📉 MACD:</strong> -5420.9</p><p><strong>📌 예측:</strong></p><ul><li style='color:#4dabf7;font-weight:600;'>3 기간 → <strong>Hold</strong> (신뢰도 55.0%)</li><li style='color:#4dabf7;font-weight:600;'>5 기간 → <strong>Hold</strong> (신뢰도 53.24%)</li><li style='color:#4dabf7;font-weight:600;'>10 기간 → <strong>Hold</strong> (신뢰도 56.1%)</li></ul></div><div style='border:1px solid #555;padding:12px;border-radius:8px;margin-bottom:12px;'><h3 style='margin-bottom:8px;color:#fff;'>⏱️ 1MO 분석</h3><p><strong>💰 현재가:</strong> $156,900.00</p><p><strong>📊 거래량:</strong> 9,019,064</p><p><strong>📈 RSI:</strong> 34.33</p><p><strong>📉 MACD:</strong> -31254.21</p><p><strong>📌 예측:</strong></p><ul><li style='color:#ff6b6b;font-weight:600;'>3 기간 → <strong>Sell</strong> (신뢰도 48.05%)</li><li style='color:#ff6b6b;font-weight:600;'>5 기간 → <strong>Sell</strong> (신뢰도 47.92%)</li><li style='color:#ff6b6b;font-weight:600;'>10 기간 → <strong>Sell</strong> (신뢰도 46.56%)</li></ul></div><div style='border-left:5px solid #28e07b;padding:12px;background:#1e1e1e;margin-top:12px;border-radius:6px;'><h3 style='margin-bottom:6px;color:#fff;'>✅ 최종 판단: <span style='font-weight:bold;'>Sell</span></h3><p style='color:#ccc;'>📌 판단 근거: 매도 신호가 우세</p><p style='color:#ccc;'>💹 매수 점수: <strong>10.00</strong> | 매도 점수: <strong>147.53</strong></p></div></div>
