---
title: "[C#] 드라이브 용량 조회하기"
date: 2020-09-15
categories: [코딩정보 > C#]
tags: ['c#', '드라이브용량체크', '하드', 'ProgressBar']
---
...
![](/assets/images/-C---드라이브-용량-조회하기/img.png)
...
![](/assets/images/-C---드라이브-용량-조회하기/img_1.png)

\- 실제 드라이브 상태

![](/assets/images/-C---드라이브-용량-조회하기/img_2.png)
