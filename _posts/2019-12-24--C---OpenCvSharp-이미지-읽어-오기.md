---
title: "[C#] OpenCvSharp 이미지 읽어 오기"
date: 2019-12-24
categories: [코딩정보 > C#]
tags: ['c#', '불러오기', '파일불러오기', 'opencv', 'opencvsharp', 'PictureBoxIpI', '그림파일넣기']
---
...
![](/assets/images/-C---OpenCvSharp-이미지-읽어-오기/img.jpg)

\- 비쥬얼스튜디오의 도구상자에서 PictureBoxIpI 컨트로를 드래그앤드롭하여 디자인폼으로 이동 시킵니다

![](/assets/images/-C---OpenCvSharp-이미지-읽어-오기/img_1.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-읽어-오기/img_2.jpg)

고정 크기를 사용하기 위해 사이즈를 320x207로 고정 시킵니다

![](/assets/images/-C---OpenCvSharp-이미지-읽어-오기/img_3.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-읽어-오기/img_4.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-읽어-오기/img_5.jpg)

\- 그 다음 그림읽기 메뉴에 클릭 이벤트 추가

![](/assets/images/-C---OpenCvSharp-이미지-읽어-오기/img_6.jpg)
