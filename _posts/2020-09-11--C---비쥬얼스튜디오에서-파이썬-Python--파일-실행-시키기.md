---
title: "[C#] 비쥬얼스튜디오에서 파이썬(Python) 파일 실행 시키기"
date: 2020-09-11
categories: [코딩정보 > C#]
tags: ['python', 'microsoft', '비쥬얼스튜디오']
---
...
![](/assets/images/-C---비쥬얼스튜디오에서-파이썬-Python--파일-실행-시키기/img.png)
...
![](/assets/images/-C---비쥬얼스튜디오에서-파이썬-Python--파일-실행-시키기/img_1.png)

* 해당 환경 변수는 PC마다 상이할수 있으니 참고만 해주세요

![](/assets/images/-C---비쥬얼스튜디오에서-파이썬-Python--파일-실행-시키기/img_2.png)
...
![](/assets/images/-C---비쥬얼스튜디오에서-파이썬-Python--파일-실행-시키기/img_3.png)
...
![](/assets/images/-C---비쥬얼스튜디오에서-파이썬-Python--파일-실행-시키기/img_4.png)
...
![](/assets/images/-C---비쥬얼스튜디오에서-파이썬-Python--파일-실행-시키기/img_5.png)
...
![](/assets/images/-C---비쥬얼스튜디오에서-파이썬-Python--파일-실행-시키기/img_6.png)
