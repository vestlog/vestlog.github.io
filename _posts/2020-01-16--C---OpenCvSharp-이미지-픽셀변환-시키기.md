---
title: "[C#] OpenCvSharp 이미지 픽셀변환 시키기"
date: 2020-01-16
categories: [코딩정보 > OpenCv]
tags: ['c#', 'RGB', 'opencv', 'Math.Round', 'opencvsharp', '픽셀변환', 'CvColor']
---
...
![](/assets/images/-C---OpenCvSharp-이미지-픽셀변환-시키기/img.jpg)

\- 그다음 픽셀변환 버튼에 클릭시 발생할 이벤트를 생성합니다

![](/assets/images/-C---OpenCvSharp-이미지-픽셀변환-시키기/img_1.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-픽셀변환-시키기/img_2.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-픽셀변환-시키기/img_3.jpg)
