---
title: "[2025-06-13] - 한국과 북한 확성기 방송 중지에 담긴 의미는"
excerpt: "한국이 지난 11일 대북 확성기 방송을 중지한 데 이어 북한도 대남 소음 방송 송출을 멈춘 것으로 보인다."
...
tags:
  ...
  - 주식종합요약
  - AI종목분석/예측
last_modified_at: 2025-06-13T10:07:49+09:00
---
...
<div style='display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:16px;'>
      ...
      <div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        ...
        <p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 51,100.00</p>
        <p style="color:#28a745;margin:0.3em 0;"><strong>📈 변동률:</strong> +1.19%</p>
      ...
      <div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        ...
        <p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 54,000.00</p>
        <p style="color:#dc3545;margin:0.3em 0;"><strong>📈 변동률:</strong> -1.10%</p>
        <p style="color:#555;margin:0.3em 0;"><strong>🔄 거래량 비율:</strong> 0.24배</p>
        <p style="color:#888;margin:0.3em 0;"><strong>🏷️ 태그:</strong> 없음</p>
      </div>
    
      <div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        <h3 style="color:#111;margin:0 0 0.5em;">삼성전자 <span style='font-size:0.9em;color:#666;'>(005930)</span></h3>
        <p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 58,700.00</p>
      ...
      <div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        ...
        <p style="color:#28a745;margin:0.3em 0;"><strong>📈 변동률:</strong> +6.70%</p>
        <p style="color:#555;margin:0.3em 0;"><strong>🔄 거래량 비율:</strong> 1.74배</p>
        <p style="color:#007bff;margin:0.3em 0;"><strong>🏷️ 태그:</strong> 급등/급락, 거래량 급증</p>
      </div>
    
      <div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        <h3 style="color:#111;margin:0 0 0.5em;">신성델타테크 <span style='font-size:0.9em;color:#666;'>(065350)</span></h3>
        <p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 82,800.00</p>
        <p style="color:#28a745;margin:0.3em 0;"><strong>📈 변동률:</strong> +14.21%</p>
      ...
      <div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        ...
        <p style="color:#555;margin:0.3em 0;"><strong>🔄 거래량 비율:</strong> 3.27배</p>
        <p style="color:#007bff;margin:0.3em 0;"><strong>🏷️ 태그:</strong> 거래량 급증</p>
      </div>
      ...
      <div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        <h3 style="color:#111;margin:0 0 0.5em;">RH <span style='font-size:0.9em;color:#666;'>(RH)</span></h3>
        <p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 176.87</p>
        <p style="color:#dc3545;margin:0.3em 0;"><strong>📈 변동률:</strong> -1.18%</p>
      ...
      <div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
        ...
        <p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 478.87</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 카카오 (035720)</h3>
  <p><strong>현재가:</strong> 51100.00 | <strong>변동률:</strong> 1.19% | <strong>거래량 비율:</strong> 0.81배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  ...
  <p><strong>현재가:</strong> 54000.00 | <strong>변동률:</strong> -1.1% | <strong>거래량 비율:</strong> 0.24배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 삼성전자 (005930)</h3>
  <p><strong>현재가:</strong> 58700.00 | <strong>변동률:</strong> -1.34% | <strong>거래량 비율:</strong> 0.21배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 카카오페이 (377300)</h3>
  <p><strong>현재가:</strong> 60500.00 | <strong>변동률:</strong> 6.7% | <strong>거래량 비율:</strong> 1.74배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 신성델타테크 (065350)</h3>
  <p><strong>현재가:</strong> 82800.00 | <strong>변동률:</strong> 14.21% | <strong>거래량 비율:</strong> 0.91배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  ...
  <p><strong>현재가:</strong> 413.68 | <strong>변동률:</strong> 0.2% | <strong>거래량 비율:</strong> 1.79배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  ...
  <p><strong>현재가:</strong> 203.75 | <strong>변동률:</strong> -4.79% | <strong>거래량 비율:</strong> 3.27배</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 RH (RH)</h3>
  <p><strong>현재가:</strong> 176.87 | <strong>변동률:</strong> -1.18% | <strong>거래량 비율:</strong> 2.09배</p>
  <p><strong>설명:</strong><br>RH, is a home furnishings retailer. The company is headquartered in Corte Madera, California.
→ **Source**: Alpha Vantage
→ 🇰🇷 **한국어 번역**: RH는 가정용 가구 소매업체입니다. 이 회사는 캘리포니아주 코르테 마데라에 본사를 두고 있습니다.</p>
  <img src="/assets/chartimg/RH_expert_chart.png" style="width:100%;max-width:600px;height:auto;border-radius:4px;margin-top:10px;" />
</div>


<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 Microsoft Corporation (MSFT)</h3>
  <p><strong>현재가:</strong> 478.87 | <strong>변동률:</strong> 1.32% | <strong>거래량 비율:</strong> 0.89배</p>
