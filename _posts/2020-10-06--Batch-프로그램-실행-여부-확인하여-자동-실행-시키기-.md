---
title: "[Batch]프로그램 실행 여부 확인하여 자동 실행 시키기."
date: 2020-10-06
categories: [코딩정보 > Windows]
tags: ['Batch파일', '프로그램', 'Batch파일로']
---
...
![](/assets/images/-Batch-프로그램-실행-여부-확인하여-자동-실행-시키기-/img.png)
...
![](/assets/images/-Batch-프로그램-실행-여부-확인하여-자동-실행-시키기-/img_1.png)
