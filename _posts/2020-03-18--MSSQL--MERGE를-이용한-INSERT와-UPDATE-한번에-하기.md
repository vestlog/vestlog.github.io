---
title: "[MSSQL] MERGE를 이용한 INSERT와 UPDATE 한번에 하기"
date: 2020-03-18
categories: [코딩정보 > MS-SQL]
tags: ['Update', 'MSSQL', 'query', 'insert', 'merge', 'INSERT와UPDATE를', 'INSERT와']
---
...
![](/assets/images/-MSSQL--MERGE를-이용한-INSERT와-UPDATE-한번에-하기/img.jpg)
...
![](/assets/images/-MSSQL--MERGE를-이용한-INSERT와-UPDATE-한번에-하기/img_1.jpg)
...
![](/assets/images/-MSSQL--MERGE를-이용한-INSERT와-UPDATE-한번에-하기/img_2.jpg)

그럼 다음 조건을 테스트하기 위해서 USER_MAST 테이블의 값을 지워 볼께요

![](/assets/images/-MSSQL--MERGE를-이용한-INSERT와-UPDATE-한번에-하기/img_3.jpg)

DELETE문을 실행했습니다

![](/assets/images/-MSSQL--MERGE를-이용한-INSERT와-UPDATE-한번에-하기/img_4.jpg)

이제 USER_MAST 테이블에는 'TEST'라는 데이터는 존재하지 않습니다

다시 MERGE문을 실행해 보겠습니다

![](/assets/images/-MSSQL--MERGE를-이용한-INSERT와-UPDATE-한번에-하기/img_5.jpg)
...
![](/assets/images/-MSSQL--MERGE를-이용한-INSERT와-UPDATE-한번에-하기/img_6.jpg)
