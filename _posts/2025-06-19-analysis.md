...
→ **English Translation**: After preliminary approval in 2015 and the establishment of a preparatory corporation in 2016, the company officially opened for business as an Internet-only bank in 2017.</p>
...
<style>
  .card { background: white; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 1.5em; margin-bottom: 2em; max-width: 700px; }
  .card h2 { margin-top: 0; color: #333; }
  .card ul { list-style-type: none; padding: 0; }
  .card li { margin-bottom: 0.5em; }
  .card img { max-width: 100%; margin-top: 1em; border-radius: 8px; }
</style>
<div class='card'>
