---
title: "[Python] 티스토리 API를 사용하여 작성글 쓰기(2)"
date: 2021-01-14
categories: [코딩정보 > Python]
tags: ['티스토리', '티스토리', '티스토리', '파이썬', '파이썬']
---
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img.png)

html 모드로 변경을 하면 아래와 같은 형태로 변경됩니다

![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img_1.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img_2.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img_3.png)

해당 구문에서 아까 글을 올리고자 하는 문자열을 html 파일 형태로 저장하고

![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img_4.png)

주석에 설명되어 있듯이 저장된 html을 읽어오는 구문 입니다

![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img_5.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img_6.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img_7.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-2-/img_8.png)
