---
title: "[C#] 데이터 그리드뷰 붙여넣기 만들기"
date: 2020-07-21
categories: [코딩정보 > C#]
tags: ['c#', 'clipboard', 'C#', '데이터그리드뷰', 'C#']
---
...
![](/assets/images/-C---데이터-그리드뷰-붙여넣기-만들기/img.png)
...
![](/assets/images/-C---데이터-그리드뷰-붙여넣기-만들기/img_1.png)  추가 버튼을 통한 Row가 추가된 화면

버튼을 눌러 붙여넣기 할 만큼의 Row를 미리 생성한뒤에 붙여 넣기 하면 그리드뷰에 데이터가 붙여넣기가 됩니다

![](/assets/images/-C---데이터-그리드뷰-붙여넣기-만들기/img_2.png)  Ctl + V를 통해 붙여넣기 된 화면
