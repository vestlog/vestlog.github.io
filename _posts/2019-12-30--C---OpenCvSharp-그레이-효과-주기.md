---
title: "[C#] OpenCvSharp 그레이 효과 주기"
date: 2019-12-30
categories: [코딩정보 > OpenCv]
tags: ['c#', 'opencv', '이미지효과', '이미지필터', 'opencvsharp', '그레이효과']
---
...
![](/assets/images/-C---OpenCvSharp-그레이-효과-주기/img.jpg)

[Source Code]

-MenuStep에서 그레이 버튼을 클릭하였을때 실행될 클릭 이벤트를 생성합니다

![](/assets/images/-C---OpenCvSharp-그레이-효과-주기/img_1.jpg)
...
![](/assets/images/-C---OpenCvSharp-그레이-효과-주기/img_2.jpg)

\- 생성된 gray.cs 파일에 다음과 같이 코딩합니다

![](/assets/images/-C---OpenCvSharp-그레이-효과-주기/img_3.jpg)
...
![](/assets/images/-C---OpenCvSharp-그레이-효과-주기/img_4.jpg)
