---
title: "[C#] 텔레그램 API를 이용한 메세지 보내기"
date: 2019-12-16
categories: [코딩정보 > C#]
tags: ['c#', 'BOT', '텔레그램', 'chatid', '텔레그램', '텔레그램bot']
---
...
![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img.jpg)

로그인 뒤에 옆 친구리시트 중에 다음과 같은 BotFather를 클릭해 줍니다

![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_1.jpg)

번역하면 봇아버지ㅋㅋ

그다음 봇 아버지에게 다음과 같이 말을 겁니다

![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_2.jpg)

/start 텔레그램을 시작하겠다는 말을 봇아버지에게 하는거죠

![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_3.jpg)
...
![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_4.jpg)

저는 이미 설치가 되어 있으서 업데이트라고 나오는데

여러분은 아마 설치라고 나오실겁니다

![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_5.jpg)
...
![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_6.jpg)

추가하게 되면 친구 리스트에 다음과 같이 나오게 되겟죠?

![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_7.jpg)

대화창으로 이동한뒤 /start라고 쳐주면

![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_8.jpg)
...
![](/assets/images/-C---텔레그램-API를-이용한-메세지-보내기/img_9.jpg)
