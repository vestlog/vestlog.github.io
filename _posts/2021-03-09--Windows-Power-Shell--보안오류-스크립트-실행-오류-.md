---
title: "[Windows Power Shell] 보안오류(스크립트 실행 오류)"
date: 2021-03-09
categories: [코딩정보 > Windows]
tags: ['관리자', 'unauthorizedAccess', 'Power', '보안', 'PSSecurityException', 'about_Execution_Policies']
---
...
![](/assets/images/-Windows-Power-Shell--보안오류-스크립트-실행-오류-/img.png)
...
![](/assets/images/-Windows-Power-Shell--보안오류-스크립트-실행-오류-/img_1.png)
...
![](/assets/images/-Windows-Power-Shell--보안오류-스크립트-실행-오류-/img_2.png)
