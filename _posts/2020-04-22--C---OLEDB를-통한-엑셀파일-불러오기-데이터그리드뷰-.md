---
title: "[C#] OLEDB를 통한 엑셀파일 불러오기(데이터그리드뷰)"
date: 2020-04-22
categories: [코딩정보 > C#]
tags: ['c#', 'oledb', '엑셀불러오기', 'C#', '엑셀', '대용량엑셀파일사용', 'C#']
---
...
![](/assets/images/-C---OLEDB를-통한-엑셀파일-불러오기-데이터그리드뷰-/img.png)
...
![](/assets/images/-C---OLEDB를-통한-엑셀파일-불러오기-데이터그리드뷰-/img_1.png)
