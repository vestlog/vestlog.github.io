---
title: "[MSSQL] ROW_NUMBER함수를 사용한 GROUP BY"
date: 2019-12-13
categories: [코딩정보 > MS-SQL]
tags: ['MSSQL', '쿼리', 'ROW_NUMBER', '중복제거', 'GroupBy']
---
...
![](/assets/images/-MSSQL--ROW_NUMBER함수를-사용한-GROUP-BY/img.jpg)
...
![](/assets/images/-MSSQL--ROW_NUMBER함수를-사용한-GROUP-BY/img_1.jpg)
