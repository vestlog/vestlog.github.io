---
title: "[오라클링크드오류]"OraOLEDB.Oracle"에서 열 정보를 가져올 수 없습니다."
date: 2023-05-09
categories: [코딩정보 > Oracle]
tags: ['오라클', 'MSSQL', '링크드서버오류', 'OraOLEDB.Oracle', '"OraOLEDB.Oracle"에', '"OraOLEDB.Oracle"에서', '"OraOLEDB.Oracle"에서']
---
...
![](/assets/images/-오라클링크드오류--OraOLEDB-Oracle-에서-열-정보를-가져올-수-없습니다-/img.png)

이런 오류가 발생하였을때 SQL Server 서버시의 시작 계정에 필요한 권한을 부여하여 해결 할 수 있습니다

![](/assets/images/-오라클링크드오류--OraOLEDB-Oracle-에서-열-정보를-가져올-수-없습니다-/img_1.png)

위의 해결 방안을 설정한 뒤 오라클의 dllhost에 정상적으로 오라클이 올라 왔는지 확인 한다

확인 방법은 아래 명령 프롬프트를 사용함

![](/assets/images/-오라클링크드오류--OraOLEDB-Oracle-에서-열-정보를-가져올-수-없습니다-/img_2.png)
