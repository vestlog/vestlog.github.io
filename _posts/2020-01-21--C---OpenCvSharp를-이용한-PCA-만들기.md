---
title: "[C#] OpenCvSharp를 이용한 PCA 만들기"
date: 2020-01-21
categories: [코딩정보 > OpenCv]
tags: ['pca', '판별', '분석', '학습', '매칭', 'c#', '검출', 'opencv', 'opencvsharp']
---
...
![](/assets/images/-C---OpenCvSharp를-이용한-PCA-만들기/img.jpg)

\- 학습과 검출 세부 버튼에 클릭시 동작 할 수 있도록 이벤트를 활성화 시킵니다

![](/assets/images/-C---OpenCvSharp를-이용한-PCA-만들기/img_1.jpg)
![](/assets/images/-C---OpenCvSharp를-이용한-PCA-만들기/img_2.jpg)
...
![](/assets/images/-C---OpenCvSharp를-이용한-PCA-만들기/img_3.jpg)
...
![](/assets/images/-C---OpenCvSharp를-이용한-PCA-만들기/img_4.jpg)
