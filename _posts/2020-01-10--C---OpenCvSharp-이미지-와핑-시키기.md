---
title: "[C#] OpenCvSharp 이미지 와핑 시키기"
date: 2020-01-10
categories: [코딩정보 > OpenCv]
tags: ['이미지편집', 'c#', 'opencv', '와핑', 'Warping', 'WarpPerspective', 'opencvsharp', '이미지왜곡', '이미지변조']
---
...
![](/assets/images/-C---OpenCvSharp-이미지-와핑-시키기/img.jpg)

\- 와핑 버튼에 아래 같이 클릭 이벤트를 생성해 주구요

![](/assets/images/-C---OpenCvSharp-이미지-와핑-시키기/img_1.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-와핑-시키기/img_2.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-와핑-시키기/img_3.jpg)
