---
title: "[C#] OpenCvSharp 얼굴검출 기능 구현하기"
date: 2019-12-30
categories: [코딩정보 > OpenCv]
tags: ['얼굴인식', 'c#', 'opencv', '이미지효과', '이미지필터', '이미지인식', 'opencvsharp', '얼굴검출']
---
...
![](/assets/images/-C---OpenCvSharp-얼굴검출-기능-구현하기/img.jpg)

[Source Code]

\- 해당 메뉴에 클릭이벤트를 기능을 만들어 주세요

![](/assets/images/-C---OpenCvSharp-얼굴검출-기능-구현하기/img_1.jpg)
...
![](/assets/images/-C---OpenCvSharp-얼굴검출-기능-구현하기/img_2.jpg)
