---
title: "[Python] 티스토리 API를 사용하여 작성글 쓰기(3)"
date: 2021-01-15
categories: [코딩정보 > Python]
tags: ['이미지', '티스토리', '티스토리', '티스토리', '파이썬', '파이썬', '티스토리', '파이썬']
---
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-3-/img.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-3-/img_1.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-3-/img_2.png)

이렇게 하면 지정한 경로에 들어가면 txt의 내용을 담고 있는 png 파일이 생성됩니다

![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-3-/img_3.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-3-/img_4.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-3-/img_5.png)
...
![](/assets/images/-Python--티스토리-API를-사용하여-작성글-쓰기-3-/img_6.png)
