---
title: "[C#] FTP를 이용한 파일 다운로드 구현하기!!"
date: 2020-06-16
categories: [코딩정보 > C#]
tags: ['FTP', 'WebClient', 'C#']
---
...
![](/assets/images/-C---FTP를-이용한-파일-다운로드-구현하기--/img.png)
![](/assets/images/-C---FTP를-이용한-파일-다운로드-구현하기--/img_1.png)
...
![](/assets/images/-C---FTP를-이용한-파일-다운로드-구현하기--/img_2.png)

저는 이렇게 양식파일다운로드라는 버튼을 하나 만들어 줬습니다

그다음 버튼의 클릭 이벤트를 생성합니다

![](/assets/images/-C---FTP를-이용한-파일-다운로드-구현하기--/img_3.png)
...
![](/assets/images/-C---FTP를-이용한-파일-다운로드-구현하기--/img_4.png)
