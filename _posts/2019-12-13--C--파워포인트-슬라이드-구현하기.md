---
title: "[C#]파워포인트 슬라이드 구현하기"
date: 2019-12-13
categories: [코딩정보 > C#]
tags: ['파워포인트', '오피스', 'c#', '코딩', '파워포인트만들기', 'PPT슬라이드']
---
...
![](/assets/images/-C--파워포인트-슬라이드-구현하기/img.jpg)

참조 관리자에서 COM탭에서 형식 라이브러리 항목중에 다음 리스트들을 참조 추가 해줍니다

![](/assets/images/-C--파워포인트-슬라이드-구현하기/img_1.jpg)  ![](/assets/images/-C--
파워포인트-슬라이드-구현하기/img_2.jpg)
