---
title: "[C#] OpenCvSharp 이미지 사각, 원형 검출하기"
date: 2020-01-09
categories: [코딩정보 > OpenCv]
tags: ['c#', 'opencv', '컨투어', '윤곽선', 'opencvsharp', '모형검출', '사각형검출', '원형검출', '이미지']
---
...
![](/assets/images/-C---OpenCvSharp-이미지-사각--원형-검출하기/img.jpg)

\- 생성된 버튼에 클릭 했을때 동작 할 수 있도록 클릭 이벤트를 설정해 줍니다

![](/assets/images/-C---OpenCvSharp-이미지-사각--원형-검출하기/img_1.jpg)
![](/assets/images/-C---OpenCvSharp-이미지-사각--원형-검출하기/img_2.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-사각--원형-검출하기/img_3.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-사각--원형-검출하기/img_4.jpg)

*사각 검출(인식율 : 90%)

![](/assets/images/-C---OpenCvSharp-이미지-사각--원형-검출하기/img_5.jpg)
