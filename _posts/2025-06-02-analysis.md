...
tags:
  ...
  - '주식종합요약'
  - 'AI종목분석/예측'
last_modified_at: '2025-06-02T18:22:36+09:00'
title: '[2025-08-13] - Post'
layout: 'post'
lang: 'ko'
permalink: '/posts/2025-06-02-analysis/'
alt_en: '/en/posts/2025-06-02-analysis/'
---
...
<p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 9,660.00</p>
...
<div style="background:#fff;border:1px solid #ccc;border-radius:10px;padding:16px;box-shadow:0 1px 4px rgba(0,0,0,0.05);">
<h3 style="color:#111;margin:0 0 0.5em;">Blueprint Medicines Corporation <span style='font-size:0.9em;color:#666;'>(BPMC)</span></h3>
<p style="color:#333;margin:0.3em 0;"><strong>💰 현재가:</strong> 101.35</p>
<p style="color:#dc3545;margin:0.3em 0;"><strong>📈 변동률:</strong> -1.66%</p>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 키스트론 (475430)</h3>
  <p><strong>현재가:</strong> 9660.00 | <strong>변동률:</strong> 0.0% | <strong>거래량 비율:</strong> 1.0배</p>
  <p><strong>설명:</strong><br>동사의 명칭은 "키스트론 주식회사" 라고 표기하며 영문으로는 "KISTRON CO., LTD." 라고 표기함.
<span class="lang-en-inline" lang="en">The name of the verb is "KISTRON Co., Ltd." in English, "KISTRON Co., Ltd."</p></span>
...
<span class="lang-en-inline" lang="en">The company was founded in 1999 and operates defense solution, rail solution, and eco plant businesses.</p></span>
...
<div style="border:1px solid #ccc;padding:15px;margin:10px 0;border-radius:8px;">
  <h3>🔹 Blueprint Medicines Corporation (BPMC)</h3>
  <p><strong>현재가:</strong> 101.35 | <strong>변동률:</strong> -1.66% | <strong>거래량 비율:</strong> 1.16배</p>
  <p><strong>설명:</strong><br>❗ 종목 설명을 가져올 수 없습니다.</p>
  <img src="/assets/chartimg/BPMC_expert_chart.png" style="width:100%;max-width:600px;height:auto;border-radius:4px;margin-top:10px;" />
...
<h2>📈 AI 종목 분석 결과</h2>
<p style='color:red;'>❌ 예측 처리 실패: PLTR - cannot convert float NaN to integer</p>
<p style='color:orange;'>⚠️ 예측 결과 없음: CLF</p>
<p style='color:red;'>❌ 예측 처리 실패: SMMT - cannot convert float NaN to integer</p>
<p style='color:orange;'>⚠️ 예측 결과 없음: BMGL</p>
