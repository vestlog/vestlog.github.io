---
title: "[텐서플로워] Tensorflow 1.x버전 코드를 Tensorflow 2.x버전으로 사용"
date: 2021-03-26
categories: [코딩정보 > TensorFlow]
tags: ['tensorflow', '텐서플로우', 'Tensorflow', 'Tensorflow', '텐서플로우', 'tf.contrib.layers.fully_connected', 'runtimeerror:', 'attributeerror:']
---
...
![](/assets/images/-텐서플로워--Tensorflow-1-x버전-코드를-Tensorflow-2-x버전으로-사용/img.png)
...
![](/assets/images/-텐서플로워--Tensorflow-1-x버전-코드를-Tensorflow-2-x버전으로-
사용/img_1.png)
