---
title: "[C#] MSSQL 접속하고 사용하기"
date: 2020-01-17
categories: [코딩정보 > C#]
tags: ['Update', 'Delete', '접속', '연동', 'c#', 'MSSQL', 'insert', 'select', '코딩', '쿼리']
---
...
![](/assets/images/-C---MSSQL-접속하고-사용하기/img.png)

2\. 본문에서 db_conn을 사용하기 위한 선언문

![](/assets/images/-C---MSSQL-접속하고-사용하기/img_1.png)
