---
title: "[C#] OpenCvSharp 이미지 템플릿 매칭"
date: 2020-01-21
categories: [코딩정보 > OpenCv]
tags: ['비교', '매칭', 'c#', '검출', 'opencv', 'opencvsharp', '템플릿매칭', '이미지비교', '찾아내기']
---
...
![](/assets/images/-C---OpenCvSharp-이미지-템플릿-매칭/img.jpg)

\- 해당 버튼에서 발생할 클릭 이벤트 활성화

![](/assets/images/-C---OpenCvSharp-이미지-템플릿-매칭/img_1.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-템플릿-매칭/img_2.jpg)
...
![](/assets/images/-C---OpenCvSharp-이미지-템플릿-매칭/img_3.jpg)
