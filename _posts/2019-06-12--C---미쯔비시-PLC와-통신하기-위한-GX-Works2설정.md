---
title: "[C#] 미쯔비시 PLC와 통신하기 위한 GX Works2설정"
date: 2019-06-12
categories: [코딩정보 > C#]
tags: ['시뮬레이션', 'c#', 'PLC', '미쯔비시', 'GX']
---
...
![](/assets/images/-C---미쯔비시-PLC와-통신하기-위한-GX-Works2설정/img.jpg)

간단한 Ladder 코드를 자것ㅇ하고 M0가 접점이 이고, D0가 랜덤하고 값을 입력하는 코드

![](/assets/images/-C---미쯔비시-PLC와-통신하기-위한-GX-Works2설정/img_1.jpg)

3\. Ladder를 작성 한뒤 Debus > Start/Stop Simulation 클릭

![](/assets/images/-C---미쯔비시-PLC와-통신하기-위한-GX-Works2설정/img_2.jpg)

4\. 시뮬레이션 가동 상태

처음 실행시 ERR 발생시 RESET 후 RUN 해야 함

![](/assets/images/-C---미쯔비시-PLC와-통신하기-위한-GX-Works2설정/img_3.jpg)

5\. 시뮬레이션 정상 가동인 상태

![](/assets/images/-C---미쯔비시-PLC와-통신하기-위한-GX-Works2설정/img_4.jpg)
