---
title: "[C#] OpenCvSharp 포인트를 찾아 영역 지정 하기"
date: 2020-01-09
categories: [코딩정보 > OpenCv]
tags: ['Rectangle', 'c#', 'opencv', 'opencvsharp', 'BoundingRect', '사각그리기']
---
...
![](/assets/images/-C---OpenCvSharp-포인트를-찾아-영역-지정-하기/img.jpg)

\- 생성된 메뉴에 클릭 이벤트 지정

![](/assets/images/-C---OpenCvSharp-포인트를-찾아-영역-지정-하기/img_1.jpg)
...
![](/assets/images/-C---OpenCvSharp-포인트를-찾아-영역-지정-하기/img_2.jpg)
...
![](/assets/images/-C---OpenCvSharp-포인트를-찾아-영역-지정-하기/img_3.jpg)
